...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.radio_otto = QtWidgets.QRadioButton(self.groupBox)
        self.radio_otto.setGeometry(QtCore.QRect(0, 20, 101, 18))
        self.radio_otto.setObjectName("radio_otto")
        self.radio_diesel = QtWidgets.QRadioButton(self.groupBox)
        self.radio_diesel.setGeometry(QtCore.QRect(0, 50, 111, 18))
        self.radio_diesel.setObjectName("radio_diesel")
        self.gridLayout.addWidget(self.groupBox, 0, 4, 3, 2)
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox.setTitle(_translate("Form", "Cycle Type"))
        self.radio_otto.setText(_translate("Form", "Otto Cycle"))
        self.radio_diesel.setText(_translate("Form", "Diesel Cycle "))
